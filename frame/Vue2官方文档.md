...
## [全局配置](https://v2.cn.vuejs.org/v2/api/#全局配置)

`Vue.config` 是一个对象，包含 Vue 的全局配置。可以在启动应用之前修改下列 property：

### [silent](https://v2.cn.vuejs.org/v2/api/#silent)
...
### [optionMergeStrategies](https://v2.cn.vuejs.org/v2/api/#optionMergeStrategies)
...
- **参考**[自定义选项的混入策略](https://v2.cn.vuejs.org/v2/guide/mixins.html#自定义选项混入策略)

### [devtools](https://v2.cn.vuejs.org/v2/api/#devtools)
...
### [warnHandler](https://v2.cn.vuejs.org/v2/api/#warnHandler)
...
### [ignoredElements](https://v2.cn.vuejs.org/v2/api/#ignoredElements)
...
### [keyCodes](https://v2.cn.vuejs.org/v2/api/#keyCodes)
...
### [performance](https://v2.cn.vuejs.org/v2/api/#performance)
...
## [全局 API](https://v2.cn.vuejs.org/v2/api/#全局-API)

### [Vue.extend( options )](https://v2.cn.vuejs.org/v2/api/#Vue-extend)
...
### [Vue.nextTick( [callback, context\] )](https://v2.cn.vuejs.org/v2/api/#Vue-nextTick)
...
- **参考**：[异步更新队列](https://v2.cn.vuejs.org/v2/guide/reactivity.html#异步更新队列)
...
### [Vue.directive( id, [definition\] )](https://v2.cn.vuejs.org/v2/api/#Vue-directive)
...
### [Vue.filter( id, [definition\] )](https://v2.cn.vuejs.org/v2/api/#Vue-filter)
...
### [Vue.component( id, [definition\] )](https://v2.cn.vuejs.org/v2/api/#Vue-component)
...
### [Vue.use( plugin )](https://v2.cn.vuejs.org/v2/api/#Vue-use)
...
### [Vue.mixin( mixin )](https://v2.cn.vuejs.org/v2/api/#Vue-mixin)
...
- **参考**：[全局混入](https://v2.cn.vuejs.org/v2/guide/mixins.html#全局混入)

### [Vue.compile( template )](https://v2.cn.vuejs.org/v2/api/#Vue-compile)
...
### [Vue.observable( object )](https://v2.cn.vuejs.org/v2/api/#Vue-observable)
...
- **用法**：
  ...
  在 Vue 2.x 中，被传入的对象会直接被 `Vue.observable` 变更，所以如[这里展示的](https://v2.cn.vuejs.org/v2/guide/instance.html#数据与方法)，它和被返回的对象是同一个对象。在 Vue 3.x 中，则会返回一个可响应的代理，而对源对象直接进行变更仍然是不可响应的。因此，为了向前兼容，我们推荐始终操作使用 `Vue.observable` 返回的对象，而不是传入源对象。

- **参考**：[深入响应式原理](https://v2.cn.vuejs.org/v2/guide/reactivity.html)

### [Vue.version](https://v2.cn.vuejs.org/v2/api/#Vue-version)
...
## [选项 / 数据](https://v2.cn.vuejs.org/v2/api/#选项-数据)
...
- **详细**：
  ...
  - `type`：可以是下列原生构造函数中的一种：`String`、`Number`、`Boolean`、`Array`、`Object`、`Date`、`Function`、`Symbol`、任何自定义构造函数、或上述内容组成的数组。会检查一个 prop 是否是给定的类型，否则抛出警告。Prop 类型的[更多信息在此](https://v2.cn.vuejs.org/v2/guide/components-props.html#Prop-类型)。
  - `default`：`any`
    为该 prop 指定一个默认值。如果该 prop 没有被传入，则换做用这个值。对象或数组的默认值必须从一个工厂函数返回。
  - `required`：`Boolean`
    定义该 prop 是否是必填项。在非生产环境中，如果这个值为 truthy 且该 prop 没有被传入的，则一个控制台警告将会被抛出。
  - `validator`：`Function`
    自定义验证函数会将该 prop 的值作为唯一的参数代入。在非生产环境下，如果该函数返回一个 falsy 的值 (也就是验证失败)，一个控制台警告将会被抛出。你可以在[这里](https://v2.cn.vuejs.org/v2/guide/components-props.html#Prop-验证)查阅更多 prop 验证的相关信息。
...
- **参考**：[Props](https://v2.cn.vuejs.org/v2/guide/components-props.html)
...
- **参考**：[计算属性](https://v2.cn.vuejs.org/v2/guide/computed.html)
...
- **参考**：[事件处理器](https://v2.cn.vuejs.org/v2/guide/events.html)
...
## [选项 / DOM](https://v2.cn.vuejs.org/v2/api/#选项-DOM)
...
- **参考**：
  ...
  - [生命周期图示](https://v2.cn.vuejs.org/v2/guide/instance.html#生命周期图示)
...
- **参考**：
  ...
  - [生命周期图示](https://v2.cn.vuejs.org/v2/guide/instance.html#生命周期图示)
  - [通过插槽分发内容](https://v2.cn.vuejs.org/v2/guide/components.html#通过插槽分发内容)
...
## [选项 / 生命周期钩子](https://v2.cn.vuejs.org/v2/api/#选项-生命周期钩子)
...
- **参考**：[生命周期图示](https://v2.cn.vuejs.org/v2/guide/instance.html#生命周期图示)
...
- **参考**：
  ...
  - [动态组件 - keep-alive](https://v2.cn.vuejs.org/v2/guide/components-dynamic-async.html#在动态组件上使用-keep-alive)
...
## [选项 / 资源](https://v2.cn.vuejs.org/v2/api/#选项-资源)
...
- **参考**：[`Vue.filter`](https://v2.cn.vuejs.org/v2/api/#Vue-filter)
...
## [选项 / 组合](https://v2.cn.vuejs.org/v2/api/#选项-组合)
...
- **参考**：[混入](https://v2.cn.vuejs.org/v2/guide/mixins.html)
...
## [选项 / 其它](https://v2.cn.vuejs.org/v2/api/#选项-其它)
...
- **参考**：[函数式组件](https://v2.cn.vuejs.org/v2/guide/render-function.html#函数式组件)
...
## [实例 property](https://v2.cn.vuejs.org/v2/api/#实例-property)
...
- **参考**：[选项 / 数据 - data](https://v2.cn.vuejs.org/v2/api/#data)
...
- **参考**：
  ...
  - [`` 组件](https://v2.cn.vuejs.org/v2/api/#slot)
  - [通过插槽分发内容](https://v2.cn.vuejs.org/v2/guide/components.html#通过插槽分发内容)
  - [渲染函数 - 插槽](https://v2.cn.vuejs.org/v2/guide/render-function.html#插槽)
...
- **参考**：
  ...
  - [`` 组件](https://v2.cn.vuejs.org/v2/api/#slot)
  - [作用域插槽](https://v2.cn.vuejs.org/v2/guide/components-slots.html#作用域插槽)
  - [渲染函数 - 插槽](https://v2.cn.vuejs.org/v2/guide/render-function.html#插槽)
...
- **详细**：
  ...
  一个对象，持有注册过 [`ref` attribute](https://v2.cn.vuejs.org/v2/api/#ref) 的所有 DOM 元素和组件实例。

- **参考**：

  - [子组件 ref](https://v2.cn.vuejs.org/v2/guide/components-edge-cases.html#访问子组件实例或子元素)
  - [特殊 attribute - ref](https://v2.cn.vuejs.org/v2/api/#ref)
...
- **参考**：[服务端渲染](https://v2.cn.vuejs.org/v2/guide/ssr.html)
...
## [实例方法 / 数据](https://v2.cn.vuejs.org/v2/api/#实例方法-数据)
...
- **参考**：[Vue.set](https://v2.cn.vuejs.org/v2/api/#Vue-set)

### [vm.$delete( target, propertyName/index )](https://v2.cn.vuejs.org/v2/api/#vm-delete)
...
- **参考**：[Vue.delete](https://v2.cn.vuejs.org/v2/api/#Vue-delete)

## [实例方法 / 事件](https://v2.cn.vuejs.org/v2/api/#实例方法-事件)

### [vm.$on( event, callback )](https://v2.cn.vuejs.org/v2/api/#vm-on)
...
### [vm.$once( event, callback )](https://v2.cn.vuejs.org/v2/api/#vm-once)
...
### [vm.$off( [event, callback\] )](https://v2.cn.vuejs.org/v2/api/#vm-off)
...
### [vm.$emit( eventName, […args\] )](https://v2.cn.vuejs.org/v2/api/#vm-emit)
...
## [实例方法 / 生命周期](https://v2.cn.vuejs.org/v2/api/#实例方法-生命周期)

### [vm.$mount( [elementOrSelector\] )](https://v2.cn.vuejs.org/v2/api/#vm-mount)
...
- **参考**：
  ...
  - [生命周期图示](https://v2.cn.vuejs.org/v2/guide/instance.html#生命周期图示)
  - [服务端渲染](https://v2.cn.vuejs.org/v2/guide/ssr.html)
...
### [vm.$nextTick( [callback\] )](https://v2.cn.vuejs.org/v2/api/#vm-nextTick)
...
## [指令](https://v2.cn.vuejs.org/v2/api/#指令)
...
- **参考**：
  ...
  - [列表渲染](https://v2.cn.vuejs.org/v2/guide/list.html)
  - [key](https://v2.cn.vuejs.org/v2/guide/list.html#key)
...
- **参考**：
  ...
  - [组件 - 插槽](https://v2.cn.vuejs.org/v2/guide/components-slots.html)
...
## [特殊 attribute](https://v2.cn.vuejs.org/v2/api/#特殊-attribute)
...
- **参考**：[子组件 ref](https://v2.cn.vuejs.org/v2/guide/components-edge-cases.html#访问子组件实例或子元素)
...
- **See also**：
  ...
  - [DOM 模板解析说明](https://v2.cn.vuejs.org/v2/guide/components.html#解析-DOM-模板时的注意事项)

### [slot 废弃](https://v2.cn.vuejs.org/v2/api/#slot-废弃)

**推荐 2.6.0 新增的 [v-slot](https://v2.cn.vuejs.org/v2/api/#v-slot)。**

- **预期**：`string`

  用于标记往哪个具名插槽中插入子组件内容。

- **参考**：[具名插槽](https://v2.cn.vuejs.org/v2/guide/components-slots.html#具名插槽)

### [slot-scope 废弃](https://v2.cn.vuejs.org/v2/api/#slot-scope-废弃)
...
- **用法**：
  ...
  用于将元素或组件表示为作用域插槽。attribute 的值应该是可以出现在函数签名的参数位置的合法的 JavaScript 表达式。这意味着在支持的环境中，你还可以在表达式中使用 ES2015 解构。它在 2.5.0+ 中替代了 [`scope`](https://v2.cn.vuejs.org/v2/api/#scope-replaced)。

  此 attribute 不支持动态绑定。

- **参考**：[作用域插槽](https://v2.cn.vuejs.org/v2/guide/components-slots.html#作用域插槽)

### [scope 移除](https://v2.cn.vuejs.org/v2/api/#scope-移除)

**被 2.5.0 新增的 [slot-scope](https://v2.cn.vuejs.org/v2/api/#slot-scope) 取代。推荐 2.6.0 新增的 [v-slot](https://v2.cn.vuejs.org/v2/api/#v-slot)。**

用于表示一个作为带作用域的插槽的 `<template>` 元素，它在 2.5.0+ 中被 [`slot-scope`](https://v2.cn.vuejs.org/v2/api/#slot-scope) 替代。

- **用法：**

  除了 `scope` 只可以用于 `<template>` 元素，其它和 [`slot-scope`](https://v2.cn.vuejs.org/v2/api/#slot-scope) 都相同。

## [内置的组件](https://v2.cn.vuejs.org/v2/api/#内置的组件)
...
- **参考**：[动态组件](https://v2.cn.vuejs.org/v2/guide/components.html#动态组件)
...
- **参考**：[过渡：进入，离开和列表](https://v2.cn.vuejs.org/v2/guide/transitions.html)
...
- **参考**：[通过插槽分发内容](https://v2.cn.vuejs.org/v2/guide/components.html#通过插槽分发内容)

## [VNode 接口](https://v2.cn.vuejs.org/v2/api/#VNode-接口)

- 请参考 [VNode class declaration](https://github.com/vuejs/vue/blob/dev/src/core/vdom/vnode.js)。

## [服务端渲染](https://v2.cn.vuejs.org/v2/api/#服务端渲染)

- 请参考 [vue-server-renderer package documentation](https://github.com/vuejs/vue/tree/dev/packages/vue-server-renderer)。

发现错误？想参与编辑？ [在 GitHub 上编辑此页！](https://github.com/vuejs/cn.vuejs.org/blob/master/src/v2/api/index.md)