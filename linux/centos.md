...
#### 2.5.5 用户组的所有信息都存放在/etc/group文件中。
...
#### 3.4.1 第一部分：一般模式可用的光标移动、复制粘贴、搜索替换等
...
#### 3.4.2 第二部分：一般模式切换到编辑模式的可用的按钮说明
...
#### 3.4.3 第三部分：一般模式切换到指令行模式的可用的按钮说明
